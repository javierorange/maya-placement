...
In Cursor, ask to **find placements** (or wait for the weekly automation). The agent reads the files above, searches public boards, appends new source URLs and matching offers, and on scheduled runs opens a pull request.
